...
def ending(character):
    ...
    if character["power"] >= 20 and character["intelligence"] >= 20 and character["tenacity"] >= 20:
        print("👑 [엔딩 5: 성군] 👑")
        print("당신은 문무와 끈기, 인품을 모두 갖춘 완벽한 성인이 되었습니다. 왕국을 다스리는 위대한 성군이 됩니다.")
    
    # 2. 마왕 (power와 krama가 높은 경우) [cite: 23]
    elif character["power"] >= 30 and character["krama"] >= 30:
        print("😈 [엔딩 2: 마왕] 😈")
        print("어둠의 힘과 업보에 굴복한 당신은 왕국을 무너뜨리고 세계를 공포에 몰아넣는 마왕이 되었습니다.")
        
    # 1. 국왕 (intelligence와 tenacity가 높은 경우) [cite: 23]
    elif character["intelligence"] >= 20 and character["tenacity"] >= 20:
        print("📜 [엔딩 1: 통치자] 📜")
        print("현명한 지혜와 백성들을 이끄는 강인한 끈기로 왕국의 정당한 왕이 되어 국가를 번영시킵니다.")
        
    # 3. 용사 (power가 가장 높은 경우)
    elif character["power"] >= character["intelligence"] and character["krama"] >= character["tenacity"]:
        print("⚔️ [엔딩 3: 용사] ⚔️")
...
character = {
    "name": " ",
    "power": 0,          # 힘
    "krama": 0,          # 업보 (오타 수정: karma 대신 요청하신 krama로 반영)
    "intelligence": 0,   # 지능 (요청하신 iintelligence로 반영)
    "tenacity": 0        # 끈기/인성
}
...
story_chapters = [
    ...
    [
        ...
        "도구를 쓰는 법과 맹견의 움직임을 계산하며 잔머리를 굴렸습니다. (power +10, iintelligence +10, krama +10)",
        "아이들을 무사히 대피시키며 강한 책임감과 지혜를 얻었습니다. (iintelligence +15, tenacity +15)",
        "맹견은 쫓아냈지만 마을 다른 곳이 난장판이 되어 원망을 듣습니다. (power +15, krama +20)"
    ],
    [
        ...
        "답안지를 훔쳐보며 치밀하게 스탯을 올렸습니다. (power +5, iintelligence +15, krama +15)",
        "정직함과 인내심으로 스스로 정답을 찾아냈습니다. (iintelligence +15, tenacity +20)",
        "라이벌을 제거하고 그 사이에 혼자 훈련을 감행했습니다. (power +15, krama +25)"
    ],
    ...
    [
        ...
        "약물의 힘과 계산된 수로 상대를 제압했습니다. (power +10, iintelligence +15, krama +15)",
        "상대의 움직임을 읽는 지혜와 끈기로 승리를 따냈습니다. (iintelligence +20, tenacity +20)",
    ...
    [
        ...
        "금단의 지식과 어둠의 힘이 뇌리에 박힙니다. (power +10, iintelligence +20, krama +20)",
        "마법적 지식과 깊은 인품을 증명하여 학자들의 신뢰를 얻습니다. (iintelligence +20, tenacity +20)",
        "아카데미가 유령들로 발칵 뒤집혔지만 강대한 무기를 손에 넣었습니다. (power +25, krama +35)"
    ],
    ...
    [
        ...
        "냉혹한 전략으로 아군의 피해 없이 승리를 거두었습니다. (power +15, iintelligence +20, krama +20)",
        "훌륭한 외교적 지혜와 인내심으로 전쟁을 막아냈습니다. (iintelligence +25, tenacity +25)",
    ...
    [
        ...
        "보이지 않는 피의 군주로서 궁정을 장악했습니다. (power +15, iintelligence +25, krama +25)",
        "백성들과 충신들의 거대한 지지를 받으며 정당한 군주로 통치할 준비를 마칩니다. (iintelligence +25, tenacity +30)",
        "수많은 피를 흘린 끝에 공포의 군주로 등극하게 됩니다. (power +30, krama +45)"
    ]
]